const daysGR = ['Κυριακή', 'Δευτέρα', 'Τρίτη', 'Τετάρτη', 'Πέμπτη', 'Πρασκευή', 'Σάββατο', 'Κυριακή']
...
function renderNotes(){
    ...
    container.innerHTML = notes.map((note) => `<div id = "${'noteTemplate' + note.key}" class="flex justify-between items-center px-[10px] py-[2px] border-b black">
